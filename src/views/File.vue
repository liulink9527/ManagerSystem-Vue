<template>
    <div>
        ...
        <div style="margin: 10px 0">
            <el-upload class="upload-demo" :show-file-list="false" action="http://localhost:8080/api/file/upload" :on-success="handleSuccess" style="display: inline-block">
        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="是否启用">
                <template slot-scope="scope">
                    <el-switch v-model="scope.row.enable" active-color="#13ce66" @change="changeState(scope.row)" inactive-color="#ccc"></el-switch>
                </template>
            </el-table-column>
